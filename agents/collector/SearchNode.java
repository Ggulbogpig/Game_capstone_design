...
/* 103 */       return 0;
/*     */     }
/* 105 */     return this.sceneSnapshot.getKillsTotal();
/*     */   }
/*     */   
/*     */   public float getkillrate() {
/* 109 */     if (this.sceneSnapshot == null) {
/* 110 */       return 0.0F;
/*     */     }
/* 112 */     if (this.sceneSnapshot.getTotalEnemies() == 0) {
/* 113 */       return 0.0F;
/*     */     }
/* 115 */     return this.sceneSnapshot.getKillsTotal() / this.sceneSnapshot.getTotalEnemies();
/*     */   }
/*     */   
/*     */   public int getTotalEnemies() {
/* 119 */     if (this.sceneSnapshot == null) {
/* 120 */       return 0;
/*     */     }
/* 122 */     return this.sceneSnapshot.getTotalEnemies();
/*     */   }
/*     */   
/*     */   public float[] getEnemiesFloatPos() {
/* 126 */     if (this.sceneSnapshot == null) {
/* 127 */       return null;
/*     */     }
/*     */     
/* 130 */     return this.sceneSnapshot.getEnemiesFloatPos();
/*     */   }
/*     */   
/*     */   public float getMarioX() {
/* 134 */     if (this.sceneSnapshot == null) {
/* 135 */       return 0.0F;
/*     */     }
/* 137 */     return this.sceneSnapshot.getMarioFloatPos()[0];
/*     */   }
/*     */   
/*     */   public float getMarioY() {
/* 141 */     if (this.sceneSnapshot == null) {
/* 142 */       return 0.0F;
/*     */     }
/* 144 */     return this.sceneSnapshot.getMarioFloatPos()[1];
/*     */   }
/*     */   
/*     */   public float getCollectRate() {
/* 148 */     if (this.sceneSnapshot == null) {
/* 149 */       return 0.0F;
/*     */     }
/* 151 */     if (this.sceneSnapshot.getTotalCoins() == 0) {
/* 152 */       return 0.0F;
/*     */     }
/* 154 */     return this.sceneSnapshot.getNumCollectedCoins() / this.sceneSnapshot.getTotalCoins();
/*     */   }
/*     */   
/*     */   public int ifWin() {
/* 158 */     if (this.sceneSnapshot == null) {
/* 159 */       return 0;
/*     */     }
/* 161 */     if (this.sceneSnapshot.getGameStatus() == GameStatus.WIN) {
/* 162 */       return 1;
/*     */     }
/* 164 */     return 0;
/*     */   }
/*     */   
/*     */   public int ifLose() {
/* 168 */     if (this.sceneSnapshot == null) {
/* 169 */       return 0;
/*     */     }
/* 171 */     if (this.sceneSnapshot.getGameStatus() == GameStatus.LOSE) {
/* 172 */       return 1;
/*     */     }
/* 174 */     return 0;
/*     */   }
...
/* 178 */     float y = ticks;
/* 179 */     float s0 = initialSpeed;
/* 180 */     return (float)(99.17355373D * Math.pow(0.89D, (y + 1.0F)) - 9.090909091D * s0 * Math.pow(0.89D, (y + 1.0F)) + 10.90909091D * y - 
/* 181 */       88.26446282D + 9.090909091D * s0);
/*     */   }
/*     */ }


/* Location:              C:\Users\hbsss\Downloads\MFEDRL-master\MFEDRL-master\Mario-AI-Framework.jar!\agents\collector\SearchNode.class
