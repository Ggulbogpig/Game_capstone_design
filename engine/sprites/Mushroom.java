...
/*  20 */     super(x, y, SpriteType.MUSHROOM);
/*  21 */     this.width = 4;
/*  22 */     this.height = 12;
/*  23 */     this.facing = 1;
/*  24 */     this.life = 0;
/*     */     
/*  26 */     if (visuals) {
/*  27 */       this.graphics = new MarioImage(Assets.items, 0);
...
/*  37 */     Mushroom m = new Mushroom(false, this.x, this.y);
/*  38 */     m.xa = this.xa;
/*  39 */     m.ya = this.ya;
...
/*  59 */       this.world.mario.getMushroom();
...
/* Location:              C:\Users\hbsss\Downloads\MFEDRL-master\MFEDRL-master\Mario-AI-Framework.jar!\engine\sprites\Mushroom.class
